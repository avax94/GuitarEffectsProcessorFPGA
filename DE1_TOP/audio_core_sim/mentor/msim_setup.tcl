...
alias com {
  echo "\[exec\] com"
  vlog "$QSYS_SIMDIR/altera_up_audio_bit_counter.v"    
  vlog "$QSYS_SIMDIR/altera_up_audio_in_deserializer.v"
  vlog "$QSYS_SIMDIR/altera_up_audio_out_serializer.v" 
  vlog "$QSYS_SIMDIR/altera_up_clock_edge.v"           
  vlog "$QSYS_SIMDIR/altera_up_sync_fifo.v"            
  vlog "$QSYS_SIMDIR/audio_core.v"                     
}
