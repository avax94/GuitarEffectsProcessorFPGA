...
//altfp_sincos CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" OPERATION="SIN" PIPELINE=36 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock data result
...
module  sinus_altfp_sincos_cordic_atan_08b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_08b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_h9b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_h9b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_i9b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_i9b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_j9b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_j9b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_k9b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_k9b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_18b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_18b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_28b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_28b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_38b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_38b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_48b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_48b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_58b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_58b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_68b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_68b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_78b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
endmodule //sinus_altfp_sincos_cordic_atan_78b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_88b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
`endif
	...
	assign
		...
		valuenode_10_w = 48'b000000000000111111111111111111111010101010101011,
		valuenode_8_w = 48'b000000000011111111111111111010101010101010110111;
endmodule //sinus_altfp_sincos_cordic_atan_88b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_atan_98b
	( 
	arctan,
	indexbit) ;
	output   [33:0]  arctan;
...
`endif
	...
	assign
		...
		valuenode_11_w = 48'b000000000000011111111111111111111111010101010101,
		valuenode_9_w = 48'b000000000001111111111111111111010101010101010110;
endmodule //sinus_altfp_sincos_cordic_atan_98b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_start_339
	( 
	index,
	value) ;
	input   [3:0]  index;
...
endmodule //sinus_altfp_sincos_cordic_start_339

//synthesis_resources = lpm_add_sub 39 lpm_mult 1 lpm_mux 1 reg 1598 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_cordic_m_a8e
	( 
	aclr,
	clken,
	clock,
...
endmodule //sinus_altfp_sincos_cordic_m_a8e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altfp_sincos_srrt_gra
	( 
	address,
	basefraction,
	incexponent,
...
endmodule //sinus_altfp_sincos_srrt_gra
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //sinus_altpriority_encoder_3e8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //sinus_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	sinus_altpriority_encoder_3e8   altpriority_encoder10
	( 
	.data(data[3:2]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	sinus_altpriority_encoder_3v7   altpriority_encoder9
	( 
	.data(data[1:0]),
...
endmodule //sinus_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	sinus_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	sinus_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[3:2]),
...
endmodule //sinus_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	sinus_altpriority_encoder_6v7   altpriority_encoder7
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder7_q));
	sinus_altpriority_encoder_6e8   altpriority_encoder8
	( 
	.data(data[7:4]),
...
endmodule //sinus_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	sinus_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //sinus_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	sinus_altpriority_encoder_bv7   altpriority_encoder5
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder5_q));
	sinus_altpriority_encoder_be8   altpriority_encoder6
	( 
	.data(data[15:8]),
...
endmodule //sinus_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	sinus_altpriority_encoder_be8   altpriority_encoder15
	( 
	.data(data[7:0]),
...
endmodule //sinus_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	sinus_altpriority_encoder_r08   altpriority_encoder3
	( 
	.data(data[15:0]),
...
`endif
	...
	sinus_altfp_sincos_srrt_gra   fp_range_table1
	( 
	...
	sinus_altpriority_encoder_qb6   clz23
	( 
...
endmodule //sinus_altfp_sincos_range_79c
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_q08
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	sinus_altpriority_encoder_r08   altpriority_encoder19
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder19_q));
	sinus_altpriority_encoder_rf8   altpriority_encoder20
	( 
	.data(data[31:16]),
...
endmodule //sinus_altpriority_encoder_q08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_qf8
	( 
	data,
	q,
	zero) ;
	...
	sinus_altpriority_encoder_rf8   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //sinus_altpriority_encoder_qf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sinus_altpriority_encoder_0c6
	( 
	data,
	q) ;
	input   [63:0]  data;
	...
	sinus_altpriority_encoder_q08   altpriority_encoder17
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder17_q));
	sinus_altpriority_encoder_qf8   altpriority_encoder18
	( 
	.data(data[63:32]),
...
`endif
	...
	sinus_altfp_sincos_cordic_m_a8e   ccc_cordic_m
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	sinus_altfp_sincos_range_79c   crr_fp_range1
	( 
	.aclr(aclr),
	...
	sinus_altpriority_encoder_0c6   clz
	( 
	...
	assign
		...
		zerovec_w = {36{1'b0}};
endmodule //sinus_altfp_sincos_cue
//VALID FILE
...
module sinus (
	...
	sinus_altfp_sincos_cue	sinus_altfp_sincos_cue_component (
				.clk_en (clk_en),
				.clock (clock),
				.data (data),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL sinus.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL sinus.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL sinus.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL sinus.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL sinus_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL sinus_bb.v FALSE
