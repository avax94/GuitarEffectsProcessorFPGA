...
//altfp_exp CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" PIPELINE=17 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock data result
...
module fpExp (
	...
	fpExp_altfp_exp_d6d	fpExp_altfp_exp_d6d_component (
				.clk_en (clk_en),
				.clock (clock),
				.data (data),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fpExp.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpExp.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpExp.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpExp_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpExp_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpExp.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpExp.cmp FALSE TRUE
